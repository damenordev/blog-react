  ...
  return (
    ...
    >
      <motion.div
        ...
        className={cn('mx-auto flex w-fit gap-4 rounded-3xl bg-card px-4 items-end pb-3', className)}
    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className={cn('absolute -top-6 left-1/2 w-fit whitespace-pre rounded-xl border bg-card text-card-foreground px-3 py-1 text-sm', className)}
          role="tooltip"
          style={{ x: '-50%' }}
        >
          {children}

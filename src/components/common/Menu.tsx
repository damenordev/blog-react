  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div
          className="relative size-14 bg-card cursor-pointer rounded-full group will-change-transform z-50 flex items-center justify-center"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div
            key={index}
            className="absolute top-0 left-0 size-14 bg-card will-change-transform flex items-center justify-center"
            style={{

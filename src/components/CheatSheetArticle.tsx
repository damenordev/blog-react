...
export const CheatSheetArticle: React.FC<ICheatSheetArticleProps> = ({ title, description, code }) => {
  ...
  return (
    <article className="bg-card p-4 md:p-8 rounded-2xl">
      ...
      {code && (
        <CodeBlock code={code} language="js">
          <div className="relative w-full">
            <CodeBlock.Code className="w-full bg-background p-6 rounded-2xl overflow-x-auto text-sm md:text-base pt-12">
              <CodeBlock.LineContent>
                <CodeBlock.Token />
              </CodeBlock.LineContent>
            </CodeBlock.Code>
            <button
              className="bg-primary text-primary-foreground rounded-xl p-1.5 absolute top-2 right-2 text-sm font-semibold transition-transform active:scale-95"
